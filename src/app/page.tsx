    ...
    return (
        <>
            <div className="flex h-[100vh] w-[100%] flex-col lg:flex-row items-center mt-10 sm:mt-0 sm:justify-center lg:justify-start lg:pl-[30px]">
                <div className="lg:w-[700px] bg-white lg:h-[95%] w-[200px] h-[200px] relative rounded-full lg:rounded-xl" style={{overflow: 'hidden'}}>
                ...
                <div className=" lg:w-[800px] w-full px-10 flex flex-col items-center lg:items-start lg:gap-7 gap-5 lg:pr-50 lg:ml-50">
