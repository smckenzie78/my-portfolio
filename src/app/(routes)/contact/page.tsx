    ...
    return (
        <>
            <div className="flex flex-col items-center mt-10 w-full">
                <h1 className={` uppercase text-center leading-15 font-[900] text-[52px] z-1`}>Contact<span className="text-cyan-600"> Me</span></h1>
                <h1 className={` uppercase text-center leading-15 font-[900] text-[#303030] text-[80px] absolute z-0`}>Contact</h1>
            </div>
            <div className="h-[80vh] flex w-full justify-center mt-20 gap-20 px-10">
                <div className="flex flex-col w-[350px] gap-5">
                    <h1 className={` uppercase text-2xl font-[600]`}>Be not afraid</h1>
