        ...
        <>
            <div className="flex">
                ...
                <div className="flex w-full flex-col pl-5">
                    <div className={`${opensans.className} bg-[#303030] uppercase text-[12px] font-[700] rounded-full text-center w-[50%] text-[#a8a8a8]`}>{props.duration}</div>
                    <div className="experience flex flex-col mt-3 gap-1">
                        ...
                        <p className={`${opensans.className} text-[16px] font-[300]`}>{props.desc}</p>
                    </div>
                </div>
            </div>
        </>
